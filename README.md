...
This repository contains the V.O.I.C.E.S Google Apps Script application. The visible product name is **V.O.I.C.E.S 2.0** and the current source/database release is **2.2**.
